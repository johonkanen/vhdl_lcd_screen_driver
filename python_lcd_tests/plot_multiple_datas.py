...
data2 = lcd_plotter.testi(np.sin(np.linspace(0 , 9  * np.pi , xsize)) , 0.3)
data3 = lcd_plotter.testi(np.sin(np.linspace(0 , 15 * np.pi , xsize)) , 0.1)
data4 = lcd_plotter.testi(np.sin(np.linspace(0 , 21 * np.pi , xsize)) , 0.05)
